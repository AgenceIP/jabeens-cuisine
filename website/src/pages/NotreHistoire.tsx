  ...
  return (
    <div ref={sectionRef} style={{ background: '#0A0A0A' }}>
      ...
      <div className="relative h-[65vh] overflow-hidden flex items-center justify-center">
        <img src="/menu/images/Butter%20Chicken.jpg" alt="" width={800} height={533} className="absolute inset-0 w-full h-full object-cover" loading="eager" style={{ objectPosition: 'center 65%' }} />
